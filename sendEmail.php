<?php
$to = 'jm273606@gmail.com';
$from = 'source@somewhere.com';
$subject = 'Text file';
$message = 'message alk;fjal falk;fj a;jfa '

//define a list of files to send along with the email. key = file to be sent. 
$attachments = array(
	'/tmp/WEDFRTS' => 'first-attachment.php')
);
